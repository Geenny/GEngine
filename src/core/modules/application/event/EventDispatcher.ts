...
import ISettings from "../options/interface/IApplicationOptions";
...
export default class EventDispatcher {
    ...
    constructor( @inject(ApplicationType.OPTIONS) protected options: ISettings) {
        this._isLogged = this.options.isLogged;
    }
