...
export default class DisplayObject extends InteractiveObject {
    ...
    // get geometryWidth() { return this._geometry && this._geometry.parameters ? this._geometry.parameters.width }
    ...
    _updatePosition() {
        ...
        if ( this._geometry.parameters && this._geometry.parameters.width && this._geometry.parameters.height ) {
    ...
    textureSet( texture ) {
        ...
        // this.texture.offset = new Vector2( 0, 0.1 );
        // this.texture.repeat.set( 0.8, 1 );
    }
